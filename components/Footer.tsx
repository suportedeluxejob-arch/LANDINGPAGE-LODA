      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col items-center mb-12">
          ...
          <img
            src={LOGO_URL}
            alt="WG PATCH Logo"
            className="h-28 w-28 md:h-32 md:w-32 object-cover rounded-full shadow-xl border-4 border-slate-800 mb-4 hover:scale-105 transition-transform duration-300"
          />
